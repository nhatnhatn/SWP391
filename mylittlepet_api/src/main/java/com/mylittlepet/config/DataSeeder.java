...
public class DataSeeder implements CommandLineRunner {
        ...
        private void createItem(String name, Item.ItemType type, Item.RarityType rarity,
                ...
                item.setImageUrl("/images/items/" + name.toLowerCase().replace(" ", "_") + ".png"); // Create stats map
                ...
                effectsMap.put("healValue", 10); // Example effect value
        ...
        private void seedPets() {
                ...
                if (demoUser == null)
                        return; // Create sample pets
                createPet("Buddy", Pet.PetType.BEAST, Pet.RarityType.COMMON, demoUser,
                                "Chú chó Golden Retriever thân thiện",
                                Arrays.asList("Tìm kiếm", "Bảo vệ", "Chơi đùa"));

                createPet("Whiskers", Pet.PetType.BEAST, Pet.RarityType.UNCOMMON, demoUser,
                ...
                createPet("Nemo", Pet.PetType.ELEMENTAL, Pet.RarityType.COMMON, demoUser,
        ...
        private void createPet(String name, Pet.PetType type, Pet.RarityType rarity, User owner,
                ...
                pet.setImageUrl("/images/pets/" + type.toString().toLowerCase() + "_" +
                                rarity.toString().toLowerCase() + ".png"); // Set stats based on rarity
