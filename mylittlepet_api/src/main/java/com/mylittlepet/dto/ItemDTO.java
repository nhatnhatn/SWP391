...
import com.mylittlepet.entity.Pet.RarityType;
...
public class ItemDTO {
    ...
    public ItemDTO(Long id, String name, ItemType type, RarityType rarity, 
                   ...
                   Map<String, Integer> stats, Map<String, String> effects,
    ...
    public void setRarity(RarityType rarity) { this.rarity = rarity; }
    ...
    public void setEffects(Map<String, String> effects) { this.effects = effects; }
